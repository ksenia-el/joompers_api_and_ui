...
class TestGetUserFollowings:
    ...
    def test_get_user_followers_with_valid_user_profile_id(self, authenticated_session, uuid_retrieval):
    ...
    def test_get_user_followings_with_non_existing_user_profile_id(self, authenticated_session, uuid_retrieval):
        profile_api = Profile(authenticated_session)
    ...
    def test_get_user_followings_with_invalid_format_user_profile_id(self, authenticated_session, uuid_retrieval):
        profile_api = Profile(authenticated_session)
        uuid = "abc"
        response_body, status_code = profile_api.get_profile_followings(uuid)
